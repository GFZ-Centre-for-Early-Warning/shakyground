...
#FIXME: pack shakemap into a class object with events,shakemap,units etc.
...
class quakemap():
    ...
    '''
    def __init__(self,event,event_specific_uncertainty,shakemap,units):
...
def shakemap2quakemap(shakemlfile):
    ...
    return quakemap(event.iloc[0],event_specific_uncertainties,grid_data,units.iloc[0])
